...
os.system('xdg-open https://www.facebook.com/profile.php?id=100090553850163')
#-------------color----------------#
...
def TARA_LOVE():
    clear()
    os.system('xdg-open https://github.com/Bayezid-400')
    ...
    if option in ['01','1']:
        BD_CLONING()
    if option in ['02','2']:
    	os.system('xdg-open https://www.facebook.com/profile.php?id=100090553850163');time.sleep(1)
    if option in ['03','3']:
    	os.system('xdg-open https://wa.me/+8801326226582');time.sleep(1)
    else:
...
def BD_CLONING():
    ...
    clear()
    print(' EXAMPLE SIM CODE : [016] [017] [013] [015] [018] [019]')
